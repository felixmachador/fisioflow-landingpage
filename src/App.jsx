        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="mt-6 bg-green-500 rounded-2xl p-6 flex items-center justify-between gap-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-black">Assistente de IA Integrada</h3>
            ...
            {plans.map((p, i) => (
              <div key={i} className={`rounded-2xl p-8 border ${p.destaque ? 'bg-green-500 border-green-400' : 'bg-white/5 border-white/10'}`}>
                ...
                <div className="mb-6 relative">
                  <span className={`text-5xl font-bold select-none blur-lg ${p.destaque ? 'text-black' : 'text-white'}`}>R${p.price}</span>
